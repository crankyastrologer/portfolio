...
<div class="flex justify-center card-container">
  <div class="space-y-4">
    ...
    <Card img="src/lib/OIP.jpeg"  horizontal size="xl" reverse={hCard} class="dark:bg-gray-950">
      <div class='justify-end flex-row'>
      <Button  shadow  size='xs' color="bg-gray-950" class='text-white hover:bg-gradient-to-r from-purple-500 to-pink-500'><Gmail size='16' class=''/></Button>
    </div>
